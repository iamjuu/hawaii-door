        ...
        {doorCards.map((door) => {
          ...
          return (
            <div
              ...
              className={`group rounded-lg w-full overflow-hidden shadow-lg h-[265px] flex flex-col justify-end border cursor-pointer transition-colors ${
                isSelected
            ...
            >
              <div className="w-full h-full flex justify-between">
                ...
                >
                  <div className="w-full max-w-[193px] pt-8">
                    <h3 className="text-[20px] font-[500] font-roboto">
                      {door.title}
                    </h3>
                  </div>
