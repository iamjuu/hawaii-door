                ...
                <div className={`flex w-full max-w-[320px] md:max-w-[400px] gap-3 md:gap-4 ${isThicknessEmpty ? "ring-2 ring-red-500 rounded-lg p-1" : ""}`}>
                  <button
                    ...
                    className={`w-full px-3 py-2 md:px-4 md:py-3 rounded-lg border-2 font-medium transition-all flex items-center justify-between ${
                      (quoteData.thickness || '1 3/8"') === '1 3/8"' ? "border-[#FF6E4A] text-black" : "border-gray-300 hover:border-orange-300 text-black bg-white"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full px-3 py-2 md:px-4 md:py-3 rounded-lg border-2 font-medium transition-all flex items-center justify-between ${
                      quoteData.thickness === '1 3/4"' ? "border-[#FF6E4A] text-black" : "border-gray-300 hover:border-orange-300 text-black bg-white"
                    }`}
                  >
                    <span className="text-sm md:text-base">1 ¾"</span>
