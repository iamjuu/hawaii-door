// // components/user/build-door/steps/Step3DoorSize.tsx
// "use client";
...
//   const [localWidth, setLocalWidth] = useState(quoteData.width || "");
// const [localHeight, setLocalHeight] = useState(quoteData.height || "");
// const [localThickness, setLocalThickness] = useState(quoteData.thickness || '1 3/8"');
// const [localQuantity, setLocalQuantity] = useState(quoteData.quantity || 1);
// const handleWidthChange = (value: string) => setLocalWidth(value);
// const handleHeightChange = (value: string) => setLocalHeight(value);
// const handleThicknessChange = (value: string) => setLocalThickness(value);
// const handleQuantityChange = (e: React.ChangeEvent<HTMLInputElement>) =>
//   setLocalQuantity(Math.max(1, parseInt(e.target.value) || 1));
// const incrementQuantity = () => setLocalQuantity((prev:any) => prev + 1);
// const decrementQuantity = () => setLocalQuantity((prev:any) => Math.max(1, prev - 1));
...
//                 className={`
//                   px-6 py-4 rounded-lg border-2 font-medium transition-all text-left
//                   ${
//                     quoteData.thickness === '1 3/8"'
...
//                 <div className="text-xs text-gray-500 mt-1">Standard Interior</div>
//               </button>
//               <button
...
//               >
//                 <div className="text-xl">1 ¾"</div>
//                 <div className="text-xs text-gray-500 mt-1">Standard Exterior</div>
//               </button>
//             </div>
//           </div>
...
//                 className="w-12 h-12 rounded-lg border-2 border-gray-300 hover:border-orange-500 flex items-center justify-center text-2xl font-bold transition-colors"
//               >
//                 −
//               </button>
//               <input
...
const Step3DoorSize = ({ quoteData, setQuoteData }: StepProps) => {
  ...
  // Local state to store values until Next is clicked
  const [localWidth, setLocalWidth] = useState(quoteData.width || "");
  const [localHeight, setLocalHeight] = useState(quoteData.height || "");
  const [localThickness, setLocalThickness] = useState(quoteData.thickness || '1 3/8"');
  const [localQuantity, setLocalQuantity] = useState(quoteData.quantity || 1);
  ...
  // Save local state to global quoteData (call this before Next)
  const saveStep3Data = () => {
    setQuoteData({
      ...quoteData,
      width: localWidth,
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`px-6 py-4 rounded-lg border-2 font-medium transition-all text-left ${
                  localThickness === '1 3/8"' ? "border-orange-500 bg-orange-50 text-orange-600" : "border-gray-300 hover:border-orange-300"
                }`}
              >
                <div className="text-xl">1 ⅜"</div>
                <div className="text-xs text-gray-500 mt-1">Standard Interior</div>
              ...
              <button
                onClick={() => handleThicknessChange('1 3/4"')}
                className={`px-6 py-4 rounded-lg border-2 font-medium transition-all text-left ${
                  localThickness === '1 3/4"' ? "border-orange-500 bg-orange-50 text-orange-600" : "border-gray-300 hover:border-orange-300"
                }`}
              >
                <div className="text-xl">1 ¾"</div>
                <div className="text-xs text-gray-500 mt-1">Standard Exterior</div>
