...
We review every message personally, no bots, no scripts, just people who know doors"
              ...
              <div className="bg-white p-6 pt-0 sm:p-6 lg:py-14 lg:px-8 rounded-xl shadow-lg h-min lg:mt-[24px]">
                ...
                <div className="space-y-4">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="text-black w-full px-4 py-3 md:py-5 border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition resize-none placeholder-gray-400 text-sm"
                  ></textarea>
      ...
      <section
        id="faq"
        className="bg-[#fdfffc] w-full py-10 sm:py-12 md:py-[50px] scroll-mt-[120px]"
      >
        <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-[60px]">
          <div className="max-w-[1400px] 2xl:mx-auto">
