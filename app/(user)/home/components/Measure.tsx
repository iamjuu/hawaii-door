      ...
      <div className="w-full px-4  md:px-15 pb-7 pt-12 md:py-16 lg:py-18 bg-white">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="order-2 lg:order-1 flex flex-col justify-between   gap-[35px] md:gap-[70px]">
              <div className="flex flex-col gap-[24px]">
          

                <h1 className=" font-Roboto  leading-12 text-[46px]  font-[600]">
                Measure Twice.  <br/> Deliver Once.
                </h1>


                <p className="font-Roboto  text-[#3B3B3B]  text-[18px] font-[300]  leading-[30px]">We’re The Island Door Company, a women-owned, Hawaiʻi-based shop delivering precision-machined wood and fiberglass doors across every island. Each door is pre-hung, labeled, and ready to install, cutting labor hours, preventing callbacks, and keeping your project on schedule. We partner with the industry’s top vendors, Simpson Door, Alliance Door Products, and Plastpro, to bring proven quality to island conditions</p>
              </div>
              <Link href="/product">
