...
const Box = () => {
  return (
    <div className="relative w-full min-h-[6px] md:h-[60px] flex flex-col md:flex-row justify-center items-center gap-4 md:gap-16 py-3 md:py-0 bg-[#F6F5F1] group cursor-pointer">
