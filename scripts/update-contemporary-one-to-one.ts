...
async function updateContemporaryOneToOne() {
  try {
    console.log("🚀 Starting 1-to-1 image update for Contemporary Collection...\n");
    ...
    for (const file of imageFiles) {
      ...
      // Example: "SD_7409-Shaker-Sticking-Clear-Fir.jpg" → "SD 7409 Shaker Sticking Clear Fir"
      const doorName = file
